...
public class Hw4 {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("Введите Фамилию Имя Отчество возраст пол (м/ж) " +
        ...
        while (!mainMenu) {
            ...
            switch (menu) {
                ...
                case 3 -> genderSort(list, "ж").forEach(System.out::println);
                case 4 -> genderSort(list, "м").forEach(System.out::println);
